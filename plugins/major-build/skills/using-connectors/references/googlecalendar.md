...
1. Call `mcp__plugin_major_major__request_resource_setup` with `connectorId: "googlecalendar"` — this prompts the user to authenticate with Google
...
**Three ways to interact with Google Calendar:**
